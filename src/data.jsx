...
<p class='px-10'>
  ...
  ensure that you get top-tier professionals who align with your company’s vision and goals.
</p>
<br />
...
<section class="mt-12 px-10">
    ...
    <p class="text-gray-600 mt-2">
        ...
        businesses find the right talent efficiently.
    </p>
    ...
    <!-- Industry 3: Healthcare & Pharmaceuticals -->
    <div class="mt-6">
...
<section class="mt-12 space-y-8 px-10">
    ...
    <!-- Industry 8: Automotive & Automobile -->
    <div>
    ...
    <!-- Industry 10: Hospitality & Travel -->
    <div>
    ...
    <!-- Industry 11: Logistics & Supply Chain -->
    <div>
    ...
    <!-- Industry 12: Media & Entertainment -->
    <div>
    ...
    content: `<div class="max-w-6xl mx-auto p-6">
        ...
        <section class="bg-white p-6 rounded-lg shadow-md mb-8">
            ...
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li><strong>End-to-End Payroll & Compliance</strong> – We handle PF, ESIC, PT, TDS, and labor law formalities.</li>
                <li><strong>Reduce HR Workload</strong> – We manage recruitment, onboarding, payroll, and exits.</li>
                <li><strong>Try Before You Hire</strong> – Convert top-performing contract staff into permanent employees.</li>
            </ul>
        </section>
