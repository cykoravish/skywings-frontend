...
function Job() {
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {filteredJobs.map((job) => (
              <div key={job.id} className="bg-white shadow-md p-4 rounded-lg border border-gray-200">
  ...
  {job.title}
                ...
                <p className=" min-h-12 max-h-14 text-gray-600 flex items-center gap-2.5 ">
                  <MdLocationOn className="text-purple-500 min-w-5 max-w-5 h-4 sm:w-5 sm:h-5" /> {job.location}
                </p>
